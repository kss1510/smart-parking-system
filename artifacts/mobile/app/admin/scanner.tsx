...
export default function AdminScannerScreen() {
  ...
  const handleRequestPermission = async () => {
    ...
    if (!res.granted) {
      Alert.alert("Camera Required", "Please enable camera access in your device settings to scan QR codes.");
    }
  };
        ...
        <View style={styles.successCard}>
          ...
          <View style={styles.detailGrid}>
            ...
            <DetailRow
              icon="clock"
              label="Entry Time"
              value={new Date(result.entryTime).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}
            />
            {(result as any).userName && (
              <>
                <View style={styles.detailDivider} />
                <DetailRow icon="user" label="Student" value={(result as any).userName} />
              </>
            )}
            {(result as any).registrationId && (
              <>
                <View style={styles.detailDivider} />
                <DetailRow icon="credit-card" label="Reg. ID" value={(result as any).registrationId} />
              </>
            )}
          </View>
  ...
  return (
    <View style={[styles.screen, { backgroundColor: C.background }]}>
      ...
      <View style={styles.modeToggle}>
        <Pressable
          onPress={() => { setMode("camera"); setError(null); }}
        ...
        >
          <View style={styles.heroCard}>
            <View style={styles.heroIcon}>
              <Feather name="hash" size={28} color={C.tint} />
            </View>
...
const styles = StyleSheet.create({
  ...
  adminBadge: {
    ...
    backgroundColor: C.warningLight, borderRadius: 20,
    paddingHorizontal: 10, paddingVertical: 4,
  },
  adminBadgeText: { fontSize: 11, fontFamily: "Inter_600SemiBold", color: C.warning },
  modeToggle: {
  ...
  scanHint: {
    marginTop: 24, color: "#fff", fontSize: 14, fontFamily: "Inter_500Medium",
    textAlign: "center",
  },
  scanLoadingOverlay: {
    ...StyleSheet.absoluteFillObject,
  ...
  heroCard: {
    backgroundColor: C.tint + "10", borderRadius: 20, padding: 24,
    alignItems: "center", borderWidth: 1, borderColor: C.tint + "20", marginBottom: 20,
  },
  heroIcon: {
  ...
  errorBanner: {
    ...
    backgroundColor: C.dangerLight, borderRadius: 10, padding: 12, marginTop: 12,
  },
  errorText: { fontSize: 13, fontFamily: "Inter_500Medium", color: C.danger, flex: 1 },
  verifyBtn: {
    backgroundColor: C.tint, borderRadius: 16,
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    paddingVertical: 16, gap: 10, marginBottom: 20,
  },
  ...
  successCard: {
    ...
    margin: 20, borderWidth: 1, borderColor: C.statusFree + "40",
  ...
  detailGrid: {
    width: "100%", backgroundColor: C.background, borderRadius: 14, padding: 16, marginBottom: 20,
  },
  ...
  scanNextBtn: {
    flexDirection: "row", alignItems: "center", gap: 8,
    borderWidth: 1.5, borderColor: C.tint, borderRadius: 12,
